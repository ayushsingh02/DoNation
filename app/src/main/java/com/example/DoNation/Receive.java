                ...
                collectionReference.add(user)
                        .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                            ...
                            public void onSuccess(DocumentReference documentReference) {
                                ...
                                intent.putExtra(Intent.EXTRA_EMAIL, new String[]{"sharma.ishu.1222@gmail.com"});
                                intent.putExtra(Intent.EXTRA_SUBJECT, "Receiving ");
                                intent.putExtra(Intent.EXTRA_TEXT,"Donor Name : "+ fullname+"\nDescription : "+description);
